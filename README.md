...
* **[React Router](https://reactrouter.com/):** Para navegação entre as páginas (SPA).
* **[Google Maps API](https://developers.google.com/maps):** Para renderização do mapa e geocodificação.
